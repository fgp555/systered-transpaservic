      ...
      <header class="appbar" style="margin-top: 45px !important;">
       ...
       <div class="container">
        ...
        <section class="main"  style="margin-top: -10px;">   
          ...
          <div class="main-top">
            <h1 style="color: aliceblue !important;">Consultar Por Prestador </h1>
          </div>
          <div class="main-skills">
            <div class="card">

              <form @submit.prevent="buscarProveedor">                            
                <label for="campo1">Selecciona Prestador</label><br>
                            <select v-model="prestadora" name="empresa">
                                ...
                                <option value="otrasaravita">Cotrasaravita</option>
      ...
      methods: {
        ...
        async buscarProveedor() {         
            try {
                ...
                const response = await axios.post('http://138.197.94.5:3000/api/ordenes/buscar_proveedor', data);
