...
.main-top {
  ...
  padding-bottom: 4px;
  /* Add some space after the top section */
  border-bottom: 1px solid #ddd;
  /* Light border to separate sections */
}
...
.main-skills {
  display: flex;
  flex-wrap: wrap;
  /* Wrap cards if they don't fit in a row */
  justify-content: space-between;
  /* Space cards evenly */
}
...
.card h3 {
  font-size: 18px;
  margin: 5px 0;
  /* Small margin above and below heading */
  font-weight: normal;
  /* Regular font weight for readability */
}
