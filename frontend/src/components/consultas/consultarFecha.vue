      ...
      <header class="appbar" style="margin-top: 45px !important;">
       ...
       <div class="container">
        ...
        <section class="main"  style="margin-top: -10px;">   
          ...
          <div class="main-top">
            <h1 style="color: aliceblue !important;">Consultar Por Fecha </h1>
          </div>
          <div class="main-skills">
            <div class="card">
              <h3 style="color: black;">Ingrese Información</h3><br>
              <form @submit.prevent="buscarFecha">                            
                  <label for="campo1">Fecha Inicio</label><br>
                  <input style="height: 24px;" type="date" v-model="fecha_inicio" required class="input"><br>
                  <label for="campo2">Fecha Fin</label><br>
                  <input style="height: 24px;" type="date" v-model="fecha_fin" required class="input"><br><br>
          ...
          <div class="main-skills">
            <div class="card">
                ...
                <td colspan="2" >
                        <label for="campo16" style="color: whitesmoke;">Resultados de la Busqueda</label>                     
                   </td>
                </tr>
        ...
        filteredOrdenes() {
          ...
          return this.ordenes
            ...
            .map((orden) => ({
              ...
              fecha:orden.fecha.slice(0, 10) // Formatear la fecha
            }));
        },
      ...
      methods: {
        async buscarFecha() {         
            try {
                ...
                const response = await axios.post('http://138.197.94.5:3000/api/ordenes/buscar_fecha', data);
...
.card {
  flex: 1; /* Para que cada tarjeta tenga el mismo ancho */
}
